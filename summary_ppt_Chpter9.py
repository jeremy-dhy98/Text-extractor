...
def create_ppt_from_summaries(summaries, output_file='Presentation.pptx'):
    ...
    title.text = "Summary Presentation_Chapter_9"
...
# Path to PDF file
pdf_path = r"C:\Users\mulwa\Desktop\BMC3.2\BMC 4.1\SoftWareEngineer\chapter_9.pdf"
...
if text:
    ...
    if summaries:
        create_ppt_from_summaries(summaries, "Document Presentation_Chapter_9.pptx")
    else:
